...
export const CHUNKS = [
  ...
  { id: 'independent', src: 'experience/independent.md', kw: 'work current now present recent independent freelance research self directed', text: 'Since January 2025 she has worked as an Independent AI/ML Engineer, designing training and deploying three production grade ML systems end to end: ThoraxNet, Devops-swarm and ClinicaQuery-AI, each shipped as a public inference API on Hugging Face Spaces.' },
