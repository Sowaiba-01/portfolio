...
export const CHUNKS = [
  ...
  { id: 'nic', src: 'experience/nic.md', kw: 'work job experience company employment backend fullstack automation', text: 'At National Incubation Center NIC Pakistan she worked as a Software Engineer from September 2022 to August 2023, building full-stack promotional workflows, integrating third-party APIs, containerizing data pipelines with Docker, and analyzing user behavioral metrics.' },
  ...
  { id: 'deepguard', src: 'projects/deepguard.md', kw: 'project deepfake fake video detection explainability dataset model fullstack accuracy', text: 'DeepGuard is her full-stack deepfake detection platform built on a fine-tuned EfficientNet-B4 reaching 91.4 percent accuracy, with GradCAM explainability showing where a video was manipulated, video timeline analysis, and an InsightFace generation pipeline for adversarial testing. Built with Next.js 14 and FastAPI. Its companion deepfake dataset has over 2000 downloads on Hugging Face.' },
  { id: 'modelsentinel', src: 'projects/modelsentinel.md', kw: 'project mlops observability monitoring drift calibration reliability health score open source library toolkit', text: 'ModelSentinel is her open-source Python toolkit for machine learning observability. It checks whether a trained model is still healthy in production through performance metrics, data drift detection with KS test and PSI, probability calibration, data-quality profiling, and a single weighted model health score, all rolled into a self-contained HTML report.' },
