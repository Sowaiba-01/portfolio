...
export const CHUNKS = [
  ...
  { id: 'sai', src: 'experience/south-asia-impex.md', kw: 'work job experience company marketing campaigns', text: 'At South Asia Impex she was a Digital Marketing Intern leading data-driven SEO and social media campaigns, delivering 100 percent of projects on time and within budget.' },
  { id: 'thorax', src: 'projects/thoraxnet.md', kw: 'project medical health healthcare xray radiology diagnosis model deployed', text: 'ThoraxNet is her production grade medical AI framework using BioMedCLIP ViT-B/16 for multi-label chest X-ray pathology detection across 14 classes, with Monte Carlo Dropout uncertainty quantification, GradCAM explainability and auto-generated radiology reports, deployed live as an API on Hugging Face.' },
  ...
  { id: 'agro', src: 'projects/agrovision-net.md', kw: 'project plant plants agriculture farming leaf disease classification model', text: 'AgroVision-Net is her deep learning system classifying plant diseases across 38 categories by fine-tuning EfficientNetB0 on the PlantVillage dataset, served with a Gradio web interface and confidence thresholding.' },
  { id: 'skills', src: 'skills.yaml', kw: 'skills technologies stack languages tools frameworks programming knows', text: 'Her skills include Python JavaScript TypeScript Java C# C++ SQL, PyTorch LLMs RAG deep learning computer vision data augmentation, Django React REST APIs, Docker Git GitHub Hugging Face Vercel and Linux.' },
  ...
  { id: 'status', src: 'about.md', kw: 'availability status open opportunities looking years experience stats', text: 'She has 1.5 plus years of professional experience, 9 plus public projects on GitHub, and is currently open to opportunities in AI and machine learning engineering.' },
];
